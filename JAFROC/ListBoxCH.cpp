...
//	CRect rectIcon(rectFull.left,rectFull.top,rectFull.left+40,rectFull.top+40); 
	CRect rectIcon(rectFull.left,rectFull.top,rectFull.left+0,rectFull.top+20); 
...
//		pDC->FillRect(rect,&CBrush(m_clrSel));	// fill item frame
		pDC->FillRect( rect, &CBrush( RGB( plot_color_table[ lpDIS->itemID % 12 ][ 0 ], plot_color_table[ lpDIS->itemID % 12 ][ 1 ], plot_color_table[ lpDIS->itemID % 12 ][ 2 ] ) ) ) ;
